...
exports.getCurrentGreeting = (language = 'en') => {
...
exports.getCurrentTimeInterval = (language = 'en') => {
...
exports.getAllTimeIntervals = () => timeIntervals;

// Get all greetings
exports.getAllGreetings = () => greetings;
